...
function Map(props) {
  ...
  const handleFilterChange = (filterName, targetValue) => event => {
    const val = event.target[targetValue];
  ...
  return (
    <Paper className={classes.root}>
        ...
        <TextField
          ...
          onChange={handleFilterChange("code", "value")}
          margin="normal"
          variant="outlined"
          type="text"
          InputProps={{
    ...
    {data && !loading && !error && data.Airport && data.Airport.length > 0 && (
      <React.Fragment>
          <FormControl>
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                ...
                value="Directs"
                checked={filterState.showDirects}
